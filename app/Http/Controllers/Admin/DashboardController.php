...
{
    $totalEarnings = Appointment::where('status', 'Completed')
    ->join('services', 'appointments.service_id', '=', 'services.id')
    ->sum('services.price');

// Get total number of employees (assuming employees are users with a certain role)
...
$totalUsers = User::count();
    ...
    return view('admin.index', compact(
        ...
        'catsPercentage', 'dogsPercentage', 'rabbitsPercentage', 'birdsPercentage','totalEarnings','totalPets','totalEmployees', 'totalUsers','totalAppointments'
    ));
}
