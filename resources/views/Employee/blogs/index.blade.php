...
<div class="container-fluid py-4" style="min-height: 100vh">
    ...
    <form method="GET" action="{{ route('employee.blogs.index') }}" class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-4 d-flex gap-2">
            ...
            <a href="{{ route('employee.blogs.index') }}" class="btn flex-grow-1" style="background-color: #FF5B2E; color: white;">
    ...
    <!-- Add Blog Button -->
    <div class="mb-4">
        <a href="{{ route('employee.blogs.create') }}" class="btn" style="background-color: #FF5B2E; color: white;">
                        ...
                        <div class="card-body d-flex flex-column p-3">
                            ...
                            @if($blog->image)
                                <img src="{{ asset('storage/'.$blog->image) }}" 
                                     class="img-fluid rounded mb-3 object-fit-cover" 
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2 mt-auto">
                                ...
                                <!-- Edit Button -->
                                <a href="{{ route('employee.blogs.edit', $blog->id) }}" 
                                   class="btn btn-warning btn-sm flex-grow-1">
                                    <i class="fas fa-edit me-1"></i> Edit
                                </a>

                                <!-- Delete Button -->
                                <form action="{{ route('employee.blogs.destroy', $blog->id) }}" 
                                      method="POST" 
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="mb-3"><i class="fas fa-align-left me-2"></i>Content</h6>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('employee.blogs.edit', $blog->id) }}" class="btn" style="background-color: #FF5B2E; color: white;">
                                    <i class="fas fa-edit me-1"></i> Edit
                                </a>
                            </div>
                        </div>
