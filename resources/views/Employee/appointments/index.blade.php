...
<div class="container-fluid py-4" style="min-height: 100vh">
    ...
    <input type="text" name="appointment_id" class="form-control" placeholder="Appointment ID..." value="{{ request('appointment_id') }}">
        ...
        <div class="col-12 col-md-2 d-flex gap-2">
            ...
            <a href="{{ route('employee.appointments.index') }}" class="btn flex-grow-1" style="background-color: #FF5B2E; color: white;">
                    ...
                    <div class="card shadow h-100">
                        <div class="card-body d-flex flex-column p-3">
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2 mt-auto">
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('employee.appointments.destroy', $appointment->id) }}" 
                                      method="POST" 
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('employee.appointments.edit', $appointment->id) }}" class="btn" style="background-color: #FF5B2E; color: white;">
                                    <i class="fas fa-edit me-1"></i> Edit
                                </a>
                            </div>
                        </div>
