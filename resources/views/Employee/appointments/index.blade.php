...
<div class="container-fluid">
    ...
    <form method="GET" action="{{ route('employee.appointments.index') }}" class="row mb-4">
        <div class="col-md-3">
        ...
        <div class="col-md-2">
            ...
            <a href="{{ route('employee.appointments.index') }}" class="btn" style="background-color: #FF5B2E;color:white">
                Reset
            </a>
        </div>
    </form>
    ...
    <div class="mb-4">
    <a href="{{ route('employee.appointments.create') }}" class="btn btn-lg" style="background-color: #FF5B2E; color: white;">
            <i class="fas fa-plus-circle"></i> Add Appointments
        </a>    </div>
                    ...
                    <div class="card shadow h-100 py-3">
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <a href="{{ route('employee.appointments.edit', $appointment->id) }}" class="btn btn-warning btn-sm mx-2">
                                    <i class="fas fa-edit"></i> Edit
                                </a>

                                <form action="{{ route('employee.appointments.destroy', $appointment->id) }}" method="POST" class="d-inline-block" id="deleteForm-{{ $appointment->id }}">
                                    @csrf
                                    @method('DELETE')
