...
<div class="container-fluid py-4" style="min-height: 100vh">
    ...
    <form method="GET" action="{{ route('admin.reviews.index') }}" class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-2 d-flex gap-2">
            ...
            <a href="{{ route('admin.reviews.index') }}" class="btn flex-grow-1" style="background-color: #FF5B2E; color: white;">
    ...
    <div class="row g-4" id="reviewList">
        ...
        @else
            @foreach($reviews as $review)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 review-card" data-name="{{ strtolower($review->user->name?? 'Deleted User') }}">
                    <div class="card shadow h-100">
                        <div class="card-body d-flex flex-column align-items-center text-center p-3">
                            <!-- User Avatar -->
                            <img src="{{ isset($review->user) && $review->user->image ? asset('storage/'.$review->user->image) : asset('assets/images/Default.png') }}"
     ...
     alt="User Avatar">
                            ...
                            <!-- Review Info -->
                            <h5 class="card-title mb-1">{{ $review->user ? $review->user->name : 'Deleted User' }}</h5>
                            <p class="text-muted small mb-2">{{ $review->service->name?? 'Deleted service' }}</p>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="reviewModalLabel-{{ $review->id }}" style="color: #FF5B2E;">
                                    <i class="fas fa-star me-2"></i>Review by {{ $review->user->name?? 'Deleted User' }}
                                </h5>
     ...
     alt="User Avatar">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="text-muted">{{ $review->service->name?? 'Deleted Service' }}</p>
