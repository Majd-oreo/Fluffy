...
<div class="container-fluid py-4" style="min-height: 105vh">
    ...
    <form method="GET" action="{{ route('admin.pets.index') }}" class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('admin.pets.index') }}" class="btn flex-grow-1" style="background-color: #FF5B2E;color:white">
                Reset
            </a>
        </div>
    </form>
    ...
    <!-- Add Pet Button -->
    <div class="mb-4">
        <a href="{{ route('admin.pets.create') }}" class="btn" style="background-color: #FF5B2E; color: white;">
    ...
    <div class="row g-4" id="petList">
        ...
        @else
            @foreach($pets as $pet)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 pet-card" 
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center mb-4">
                                    <img src="{{ $pet->image ? asset('storage/'.$pet->image) : asset('assets/images/Default.png') }}" 
                                         ...
                                         alt="Pet Image">
                                    <h5>{{ $pet->name }}</h5>
                                    <span class="badge bg-{{ $pet->type == 'Dog' ? 'primary' : ($pet->type == 'Cat' ? 'info' : ($pet->type == 'Bird' ? 'warning text-dark' : 'secondary')) }}">
                                        {{ $pet->type }}
                                    </span>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="text-muted">{{ $pet->user->name?? 'Deleted User' }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('admin.pets.edit', $pet->id) }}" class="btn" style="background-color: #FF5B2E; color: white;">
                                    <i class="fas fa-edit me-1"></i> Edit
                                </a>
                            </div>
                        </div>
