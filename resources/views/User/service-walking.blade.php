            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="about-petnest-left inner-page">
                        <h5>Services <span>/ Walking</span></h5>
                        <h1>Professional Pet <br class="d-xl-block d-none"> Walking Services for <br
                                class="d-xl-block d-none"> Your Furry Friend</h1>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="about-petnest-right-wrapper about-petnest-walking">
                        <div class="about-petnest-right">
                            <figure><img src="./assets/images/services/services-hero03.png" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="petnest-showcase-gallery walking-showcase-gallery">
                        <div class="single-petnest-picture">
                            <figure><img src="./assets/images/services/walking01.png" alt=""></figure>
                            <a href="./assets/images/services/walking01.png" class="click-to-large"><span><i
                                        class="flaticon-add"></i></span></a>
                        </div>
                        <div class="petnest-showcase-gallery-bottom">
                            <div class="single-petnest-picture">
                                <figure><img src="./assets/images/services/walking02.png" alt=""></figure>
                                <a href="./assets/images/services/walking02.png" class="click-to-large"><span><i
                                            class="flaticon-add"></i></span></a>
                            </div>
                            <div class="single-petnest-picture">
                                <figure><img src="./assets/images/services/walking03.png" alt=""></figure>
                                <a href="./assets/images/services/walking03.png" class="click-to-large"><span><i
                                            class="flaticon-add"></i></span></a>
                            </div>
                            <div class="single-petnest-picture">
                                <figure><img src="./assets/images/services/walking04.png" alt=""></figure>
                                <a href="./assets/images/services/walking04.png" class="click-to-large"><span><i
                                            class="flaticon-add"></i></span></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="petnest-grooming-pay petnest-walking-pay">
                        ...
                        <div class="grooming-cart walking-time">
                            <h5>Walking Time</h5>
                            <input type="time">
                        </div>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show product-description active" id="petnest-desc" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="grooming-showcase-right">
                                                <figure><img src="./assets/images/services/walking-pet.png" alt="">
                                                </figure>
                                                <h3>Figure: <span>Walking Pet</span></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="grooming-benifits">
                                    ...
                                    <h3>Benefits</h3>
                                    <ul>
                                        <li><span>Guaranteed service (if your walker is <br class="d-md-block d-none">
                                                sick we always have a backup)</span></li>
                                        <li><span>Over one million dogs safely walked</span></li>
                                        <li><span>NO pack walks</span></li>
                                        <li><span>Walkers are bonded and insured</span></li>
                                        <li><span>Unique four-point safety system</span></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-8">
                                            <div class="grooming-showcase-left grooming-showcase-left-requirements">
                                                ...
                                                <ul>
                                                    <li>Must be a responsible and reliable pet walker, able to handle a
                                                        variety of breeds and temperaments.</li>
                                                    <li>Must have a valid driver's license and access to a reliable
                                                        vehicle for transportation.</li>
                                                    <li>Must be physically fit and able to handle long walks with pets..
                                                    </li>
                                                    <li>Must have a valid pet first aid certification.</li>
                                                    <li>Must be able to work flexible hours, including weekends and
                                                        holidays.</li>
                                                    <li>Must be able to provide references and pass a background check.
                                                    </li>
                                                    <li>Must be able to provide proof of liability insurance coverage.
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="grooming-showcase-right">
                                                <figure><img src="./assets/images/services/walking-pet02.png" alt="">
                                                </figure>
                                                <h3>Figure: <span>Walking Pet</span></h3>
                                            </div>
                                        </div>
